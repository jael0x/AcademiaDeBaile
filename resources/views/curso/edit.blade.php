...
<form method="POST" action="{{ url("admin/cursos/edit/{$curso->id}") }}">
    {{ method_field('PUT') }}        
    {{ csrf_field() }}
    ...
    <div class="row mg-b0">
        <div class="col s6">
            <div class="input-field">
                ...
                <input type="number" name="edad_min" id="edad_min" value="{{ old('edad_min', $curso->edad_min) }}">
        ...
        <div class="col s6">
            <div class="input-field">
                ...
                <input type="number" name="edad_max" id="edad_max" value="{{ old('edad_max', $curso->edad_max) }}">
    ...
    <div class="row mg-b0">
        <div class="col s6">
            <div class="input-field">
                ...
                <input type="number" name="precio_inscripcion" id="precio_inscripcion" value="{{ old('precio_inscripcion', $curso->precio_inscripcion) }}">
        ...
        <div class="col s6">
            <div class="input-field">
                ...
                <input type="number" name="precio_mensual" id="precio_mensual" value="{{ old('precio_mensual', $curso->precio_mensual) }}">
        ...
        <div class="col s6">
            ...
            <select class="browser-default" name="periodo_id" id="periodo_id" style="border: 1px solid #9e9e9e;">
                ...
                @foreach ($periodos as $periodo)
                    @if ($periodo->id == old('periodo_id', $curso->periodo_id))
        ...
        <div class="col s6">
            ...
            <select class="browser-default" name="color_id" id="color_id" style="border: 1px solid #9e9e9e;">
                ...
                @foreach ($colors as $color)
                    @if ($color->id == old('color_id', $curso->color_id))
        ...
        <div class="card-content">
            ...
            <div class="card-action pd-b0">
                ...
                <div class="input-field mg-b0" style="margin-top: 2px;">
                    <span id="mhoras" class="helper-text red-text">{{$errors->first('itemTitulo')}}</span>
                </div>
                <div id="horarios"></div>
            </div>
        </div>
    ...
    <button id="submitbtn" class="btn waves-effect waves-light" type="submit">Actualizar</button>
</form>
@endsection