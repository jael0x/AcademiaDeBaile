...
<form method="POST" action="{{ url('admin/periodos/create') }}">
    {{ csrf_field() }}
    ...
    <div class="row">
        ...
        <div class="col s6">
            <div class="input-field">
                ...
                <input type="number" name="anio_ini" id="anio_ini" value="{{ old('anio_ini') }}" min="2018">
    ...
    <div class="row">
        ...
        <div class="col s6">
            <div class="input-field">
                ...
                <input type="number" name="anio_fin" id="anio_fin" value="{{ old('anio_fin') }}" min="2018">
