...
<div class="card">
    ...
    <div class="card-stacked">
        ...
        <div class="card-action">
            ...
            <a href="/admin/eventos" class="orange-text text-darken-4 waves-effect waves-light"><i class="fas fa-arrow-left"></i> Regresar</a>
        </div>
    </div>
</div>
...
<div id="my-modal" class="my-modal">
    <div class="card grey lighten-2 modal-card">
        ...
        <div class="card-action">
            <form action="{{route('eventos.delete', $notieven)}}" method="POST" class="bet">
