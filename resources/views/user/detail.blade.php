    ...
    <div class="card-stacked">
        <div class="card-content" style="padding-top: 5px;">
            <blockquote class="blockquote" style="margin : 0;">
                <span class="card-title" style="margin-bottom : 0;"><strong>{{$user->name}}</strong></span>
            </blockquote>
            <p>
        ...
        <div class="card-action">
            <a href="/admin/users" class="orange-text text-darken-4 waves-effect waves-light"><i class="fas fa-arrow-left"></i> Regresar</a>
        </div>
    </div>
</div>
...
<div id="my-modal" class="my-modal">
    <div class="card grey lighten-2 modal-card">
        ...
        <div class="card-action">
            <form action="{{route('users.delete', $user)}}" method="POST" class="bet">
