    ...
    <div class="card-stacked">
        <div class="card-content" style="padding-top: 5px;">
            <blockquote class="blockquote" style="margin : 0;">
                <span class="card-title" style="margin-bottom : 0;"><strong>{{$teatro->nombre}}</strong></span>
            </blockquote>
                <span><label for="">Dirección: </label> {{$teatro->direccion}}</span>
        <div class="card-action">
            <a href="/admin/teatros" class="orange-text text-darken-4"><i class="fas fa-arrow-left"></i> Regresar</a>
        </div>
    </div>
</div>
</div>
...
<div id="my-modal" class="my-modal">
    <div class="card grey lighten-2 modal-card">
        ...
        <div class="card-action">
            <form action="{{route('teatros.delete', $teatro)}}" method="POST" class="bet">
